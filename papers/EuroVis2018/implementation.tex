...
\todo{check rewording of first sentence - was ``In addition to applying
  constraints relative to domain-specific properties, it may be important
  to identify properties of the graph structure.''}
