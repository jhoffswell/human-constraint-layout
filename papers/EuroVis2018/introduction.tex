...
and social networks \cite{rothenberg1998using} \orange{[additional
    citations]}, among many others. A graph layout may utilize
...
% skills or creating a layout by hand.
...
layout. To demonstrate the \jheer{ease and extensibility (??)} of our language, we
