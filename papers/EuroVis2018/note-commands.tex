...
\definecolor{figuregreen}{RGB}{198,219,199} % medium figure green: brightness: 40->65
\definecolor{figureblue}{RGB}{182,197,212} % medium figure blue: brightness: 40->65
\definecolor{figurepurple}{RGB}{180,165,196} % medium figure purple: brightness 40->65
\newcommand{\figuregreen}[1]{\textcolor{figuregreen}{\textbf{#1}}}
\newcommand{\figureblue}[1]{\textcolor{figureblue}{\textbf{#1}}}
\newcommand{\figurepurple}[1]{\textcolor{figurepurple}{\textbf{#1}}}
...
\newcommand{\figureline}[3]{\mbox{Figure~\ref{#1}#2, \linenumber{#3}}}
