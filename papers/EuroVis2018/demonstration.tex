...
% (efficiency or learnability are other ideas) 2b spacing on nodes syphilis
% (does circle order matter?)
...
network. For example, Kruger National Park includeds a simple visualization
...
Baskerville et al. \cite{baskerville2011spatial}; this food web depicts the
relationship between 161 plants, herbivores, and carnivores with 592 links
