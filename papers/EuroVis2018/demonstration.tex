...
\todo{AB: changed ``young men'' to just ``men'' -- is this correct?}
...
\todo{AB: delete the phrase ``while many layouts may be produced by hand''?
  Why is this relevant \ldots presumably any layout can be produced by hand??}
