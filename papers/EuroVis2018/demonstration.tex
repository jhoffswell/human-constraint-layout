...
\feedback{Younghoon}{Meanings of Purple/Blue/Green highlights?}
...
\feedback{Younghoon}{I agree with removing/replacing the quote.}
...
\feedback{Zening}{Could you be more specific about ``effectively''? I think 
in Fig 3 b the nodes in each cluster is more aligned. They form a circle, 
or a straight line, or a matrix. So that's easier to perceive by the eyes?} The
...
\feedback{Zening}{I think if the recreation is exactly the same as the 
original figure, it can be omitted. You already said in the text the 
recreation of the original figure can be done with three constraint 
definitions and three SetCoLa constraints. Showing the improved layout 
...
\feedback{Younghoon}{If you have a space, could you explain why the Group 
13 looks different between the original and the SetCoLa example?}
