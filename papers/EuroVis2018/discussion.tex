...
\todo{AB: check the above. I wanted to continue to separate out the
  specification of the constraints from the impleentation. Or did I
  misinterpret the previous version (which instead implied that the layout
  didn't satisfy all the SetCoLa constraints?)  The first sentence probably
should be revised if my rewrite is OK.}
