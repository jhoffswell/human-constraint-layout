...
\jheer{This might be worth addressing when you get to the section introducing the various constraints the language supports. You'll want some rationale that helps address questions like ``why these constraints?'' and ``why not others?''.}
